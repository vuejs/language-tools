...
export function createVueLanguageModule(
	ts: typeof import('typescript/lib/tsserverlibrary'),
	rootDir: string,
	compilerOptions: ts.CompilerOptions,
	_vueCompilerOptions: VueCompilerOptions,
	extraPlugins: VueLanguagePlugin[] = [],
): EmbeddedLanguageModule & { plugins: ReturnType<VueLanguagePlugin>[] } {

	const plugins = getDefaultVueLanguagePlugins(ts, rootDir, compilerOptions, _vueCompilerOptions, extraPlugins);
