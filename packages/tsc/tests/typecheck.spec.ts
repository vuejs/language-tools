	...
	test(`TypeScript - Stable`, () => {
		expect(
			...
			[
			  ...
			  "test-workspace/tsc/failureFixtures/directives/main.vue(10,6): error TS2339: Property 'notExist' does not exist on type '{ exist: {}; Comp: (props: { foo: string; }) => any; $: ComponentInternalInstance; $data: {}; $props: {}; $attrs: Data; $refs: Data; $slots: Readonly<InternalSlots>; ... 8 more ...; $watch<T extends string | ((...args: any) => any)>(source: T, cb: T extends (...args: any) => infer R ? (args_0: R, args_1: R, args_2: ...'.",
			  "test-workspace/tsc/failureFixtures/directives/main.vue(15,6): error TS2339: Property 'notExist' does not exist on type '{ exist: {}; Comp: (props: { foo: string; }) => any; $: ComponentInternalInstance; $data: {}; $props: {}; $attrs: Data; $refs: Data; $slots: Readonly<InternalSlots>; ... 8 more ...; $watch<T extends string | ((...args: any) => any)>(source: T, cb: T extends (...args: any) => infer R ? (args_0: R, args_1: R, args_2: ...'.",
			  "test-workspace/tsc/failureFixtures/directives/main.vue(18,2): error TS2578: Unused '@ts-expect-error' directive.",
			  "test-workspace/tsc/failureFixtures/directives/main.vue(21,2): error TS2578: Unused '@ts-expect-error' directive.",
			]
		`);
	});
});
