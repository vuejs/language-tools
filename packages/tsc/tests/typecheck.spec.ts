...
test(`vue-tsc`, () => {
	...
	expect(
		...
		[
		  ...
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(205,22): error TS18047: 'importedNull' is possibly 'null'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(205,36): error TS18047: 'importedNull' is possibly 'null'.",
