	...
	test(`TypeScript - Stable`, () => {
		expect(
			...
			[
			  ...
			  "test-workspace/tsc/failureFixtures/#4972/main.vue(6,3): error TS2345: Argument of type '{}' is not assignable to parameter of type '{ modelValue: unknown; "onUpdate:modelValue"?: ((value: unknown) => any) | undefined; } & VNodeProps & AllowedComponentProps & ComponentCustomProps & Record<...>'.
			  ...
			  "test-workspace/tsc/failureFixtures/#4972/main.vue(7,3): error TS2345: Argument of type '{ whatever: string; }' is not assignable to parameter of type '{ modelValue: unknown; "onUpdate:modelValue"?: ((value: unknown) => any) | undefined; } & VNodeProps & AllowedComponentProps & ComponentCustomProps & Record<...>'.
