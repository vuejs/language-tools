	...
	test(`TypeScript - Stable`, () => {
		expect(
			...
			[
			  ...
			  "test-workspace/tsc/failureFixtures/#4972/main.vue(7,3): error TS2345: Argument of type '{}' is not assignable to parameter of type '{ readonly modelValue: string; readonly "onUpdate:modelValue"?: ((value: string) => any) | undefined; } & VNodeProps & AllowedComponentProps & ComponentCustomProps & Record<...>'.
			  Property 'modelValue' is missing in type '{}' but required in type '{ readonly modelValue: string; readonly "onUpdate:modelValue"?: ((value: string) => any) | undefined; }'.",
			  "test-workspace/tsc/failureFixtures/#4972/main.vue(8,3): error TS2345: Argument of type '{}' is not assignable to parameter of type '{ modelValue: unknown; "onUpdate:modelValue"?: ((value: unknown) => any) | undefined; } & VNodeProps & AllowedComponentProps & ComponentCustomProps & Record<...>'.
			  ...
			  "test-workspace/tsc/failureFixtures/#4972/main.vue(9,3): error TS2345: Argument of type '{ whatever: string; }' is not assignable to parameter of type '{ modelValue: unknown; "onUpdate:modelValue"?: ((value: unknown) => any) | undefined; } & VNodeProps & AllowedComponentProps & ComponentCustomProps & Record<...>'.
