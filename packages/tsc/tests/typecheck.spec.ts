...
test(`vue-tsc`, () => {
	...
	expect(
		...
		[
		  "test-workspace/tsc/#2472/generic.vue(1,34): error TS6196: 'T' is declared but never used.",
		  "test-workspace/tsc/#2754/child.vue(1,34): error TS6196: 'Row' is declared but never used.",
		  "test-workspace/tsc/#3257/child.vue(1,34): error TS6196: 'T' is declared but never used.",
		  "test-workspace/tsc/#3289/child.vue(1,35): error TS6196: 'T' is declared but never used.",
		  "test-workspace/tsc/#3318/child.vue(1,34): error TS6196: 'T' is declared but never used.",
		  "test-workspace/tsc/#3379/child.vue(1,34): error TS6196: 'T' is declared but never used.",
		  "test-workspace/tsc/#3440/main.vue(1,34): error TS6196: 'T' is declared but never used.",
		  "test-workspace/tsc/#3819/component.vue(1,34): error TS6196: 'T' is declared but never used.",
		  "test-workspace/tsc/#4890/main.vue(1,34): error TS6196: 'T' is declared but never used.",
		  "test-workspace/tsc/#5120/comp.vue(3,34): error TS6196: 'T' is declared but never used.",
		  ...
		  "test-workspace/tsc/_failed_#4569/main.vue(1,34): error TS6196: 'TItem' is declared but never used.",
