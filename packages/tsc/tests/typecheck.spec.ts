...
test(`vue-tsc`, () => {
	...
	expect(
		...
		[
		  ...
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(180,43): error TS2345: Argument of type 'boolean' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(181,51): error TS2345: Argument of type 'boolean' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(184,46): error TS2345: Argument of type 'boolean' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(185,48): error TS2345: Argument of type 'string | undefined' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(188,59): error TS2345: Argument of type 'string | undefined' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(189,65): error TS2345: Argument of type 'string | undefined' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(192,2): error TS2578: Unused '@ts-expect-error' directive.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(194,2): error TS2578: Unused '@ts-expect-error' directive.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(198,36): error TS1166: A computed property name in a class property declaration must have a simple literal type or a 'unique symbol' type.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(201,26): error TS2464: A computed property name must be of type 'string', 'number', 'symbol', or 'any'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(201,27): error TS2538: Type 'Ref<"m", "m">' cannot be used as an index type.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(208,20): error TS2345: Argument of type 'number & { value: number; }' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(211,43): error TS2345: Argument of type '1 | 2 | 3' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(212,53): error TS2345: Argument of type '1 | 2' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(212,85): error TS2345: Argument of type '"a" | "b"' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(215,55): error TS2345: Argument of type 'string | Ref<number, number>' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(216,65): error TS2345: Argument of type 'number | Ref<number, number>' is not assignable to parameter of type 'never'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(219,13): error TS18048: 'fnUndef' is possibly 'undefined'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(219,35): error TS18048: 'fnUndef' is possibly 'undefined'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(220,27): error TS18048: 'fnUndef' is possibly 'undefined'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(221,13): error TS18048: 'strUndef' is possibly 'undefined'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(221,36): error TS18048: 'strUndef' is possibly 'undefined'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(222,27): error TS18048: 'strUndef' is possibly 'undefined'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(223,13): error TS18047: 'fnNull' is possibly 'null'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(223,34): error TS18047: 'fnNull' is possibly 'null'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(224,27): error TS18047: 'fnNull' is possibly 'null'.",
		  "test-workspace/tsc/unwrapBindingAccess/main.vue(225,44): error TS2345: Argument of type '1' is not assignable to parameter of type 'never'.",
