...
export function useSfcTemplateScript(
	...
	const data = computed(() => {
		...
		codeGen.addText('declare var __VLS_components_0: __VLS_GlobalComponents & typeof __VLS_vmUnwrap.components & typeof __VLS_ctxRaw & typeof __VLS_ownComponent;\n'); // has __VLS_options
		codeGen.addText('declare var __VLS_components: __VLS_ExtractRawComponents<__VLS_GlobalComponents> & __VLS_ExtractRawComponents<typeof __VLS_vmUnwrap.components> & __VLS_ExtractRawComponents<typeof __VLS_ctxRaw> & __VLS_ExtractRawComponents<typeof __VLS_ownComponent> & JSX.IntrinsicElements;\n'); // sort by priority
